...
<!-- start form -->
    <div class="container">
      <form action="" method="POST" enctype="multipart/form-data" > 
        <input type="hidden" name="gambarLama" value="<?= $ygMaudiedit[0]["Ket/Foto"]?>">
        <div class="row">
          <div class="col side" >
            <div class="md-6">
          ...
          <div class="col side">
            ...
            <div class="md-6">
                ...
                <img src="img/<?= $ygMaudiedit[0]["Ket/Foto"]?>" alt="">
                <input type="file" class="form-control" name="Ket/Foto" >
            </div>
            <br>
            <div class="d-grid gap-2">
              <button type="submit" name="submit" class="justify-conten-center btn btn-success d-grid gap-2">Edit</button>
            </div>
          </div>
        </div>
      </form>
